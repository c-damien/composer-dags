...
def ingest_to_bq(known_args, options):
    ...
    with beam.Pipeline(options=options) as p:
      ...
      pb_data = (p      | "Read file" >> beam.io.ReadFromText(known_args.input)
                        ...
                        | 'write to bq' >> beam.io.WriteToBigQuery(table=known_args.output, schema='EMPLOYEE_ID:INT64,FIRST_NAME:string,LAST_NAME:string,EMAIL:string,PHONE_NUMBER:string,ROLE:string,SALARY:INT64',
